 ...
 *  events.) For each call to the method MyCalendar.book, return an integer K representing the largest integer such that
 *  there exists a K-booking in the calendar. Your class will be called like this: MyCalendarThree cal = new MyCalendarThree();
 ...
 * **/
public class BST_MyCalendarIII {
    private TreeMap<Integer, Integer> tree;
    public BST_MyCalendarIII() {
        tree = new TreeMap<>();
    }
