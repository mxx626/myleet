...
public class FindDuplicateFileinSystem {
     ...
     * terms of their paths.
     ...
     You may assume the directory name, file name and file content only has letters and digits, and t
     he length of file content is in the range of [1,50].
    ...
    public List<List<String>> findDuplicate(String[] paths) {
        ...
        for (String path : paths){
            ...
            for (int i=1; i<file.length; ++i){
                ...
                String key = file[i].substring(idx);
                String content = file[0] + "/" + file[i].substring(0, idx);
