...
public class OutputContestMatches {
     ...
     * need to output their final contest matches in the form of a string.
     ...
     process in each round, you always need to follow the strategy of making the rather
     ...
     And we got (1,4),(2,3).
     In the second round, the winners of (1,4) and (2,3) need to play again to generate the f
     inal winner, so you need to add the paratheses outside them.
